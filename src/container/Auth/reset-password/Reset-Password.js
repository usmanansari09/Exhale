        ...
        <div className={`container ${styles.page_main}`}>
          ...
          <form className="mt-5" onSubmit={this.click}>
            ...
            <span className="position-relative">
              ...
              <i
                className={
                  this.state.show_hide ? 'hide-show fa fa-eye' : 'hide-show fa fa-eye-slash'
                }
            ...
            <div className="mt-3 mb-3">
              ...
              <span className="position-relative">
                ...
                <i
                  className={
                    this.state.show_hide2 ? 'hide-show fa fa-eye' : 'hide-show fa fa-eye-slash'
                  }
                  onClick={this.changeShowHide2}
                ></i>
              </span>
