...
const ClassesList = ({ loading, get_data }) => {
  ...
  const getAllExercises = useCallback(async () => {
    ...
    if (response.status >= 400) {
      ...
      setExerciseDetail(response.lesson_status);
    }
  }, [loading]);
  ...
  function goToDetailPage(data, history, key) {
    ...
    history.push('/dashboard/classesDetail');
  }
            ...
            <div className="all-exercises all" key={key}>
              <div className="all_items">
                ...
                <div className="all_item2" onClick={() => goToDetailPage(data, history, key)}>
                  ...
                  <div className="e-detail">{data.lesson['description']}</div>
                </div>
              </div>
            </div>
          ))
              ...
              <div className="all-exercises incomplete_exercices" key={key}>
                <div className="all_items">
                  ...
                  <div className="all_item2" onClick={() => goToDetailPage(dataVal, history, key)}>
                    ...
                    <div className="overview">Overview</div>
                    <div className="e-detail">{dataVal.lesson['description']}</div>
                  </div>
                </div>
              </div>
            ) : null
              ...
              <div className="all-exercises completed_exercises" key={key}>
                <div className="all_items">
                  ...
                  >
                    ...
                    <div className="overview">Overview</div>
                    <div className="e-detail">{dataValue.lesson['description']}</div>
                  </div>
                </div>
              </div>
            ) : null
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ClassesList));
