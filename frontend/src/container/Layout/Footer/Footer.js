               ...
               <Container>
                    <Row >
                        <Col md={4} className="mt-5">                           
                            ...
                            <p>An online pen pal exchange between students in the U.S. and Pakistan aimed to foster friendships, build relations, 
                                and dissolve cultural stereotypes
                            </p>  
                            ...
                            <p>+1 (970) 456-5463</p> 
                            <p>macy.hopkinson@gmail.com<br/> exchangetochange.com
                            </p>                         
                        </Col>
                ...
                <Container fluid>
                    <Row>
                        <Col className="mb-3">
                            ...
                            Copyright © 2020 PenPal™. All Rights Reserved.
                            </div>
                        </Col>
                    </Row>
                </Container>
