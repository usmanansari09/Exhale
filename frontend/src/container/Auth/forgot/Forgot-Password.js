...
class Forgot_Password extends Component {
    ...
    click = async (e)=>{
            ...
            else
            {
                ...
                let response = await forgotPassword({email:this.state.email,password:this.state.password});
                    ...
                    <form className="mt-5" onSubmit={this.click}>
                        <div className="mb-3">
                            ...
                            <span className="position-relative">
                                <input type="email" placeholder="Enter User Name" name="email" value={this.state.email}
